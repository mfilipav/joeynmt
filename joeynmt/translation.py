...
class TranslationDataset(data.Dataset):
    ...
    def __init__(self, path, exts, fields, cont_input_features, **kwargs):
        ...
        if cont_input_features:
            # TODO
            with io.open(src_path, mode='rb') as src_file, \
                    io.open(trg_path, mode='r', encoding='utf-8') as trg_file:
                pose_features = pickle.load(src_file)
                for src_line, trg_line in zip(pose_features, trg_file):
